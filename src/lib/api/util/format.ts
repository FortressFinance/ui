...
export const toSignificant = (
  ...
  return numericValue.toLocaleString("en-US", { maximumSignificantDigits : significantDigits, useGrouping: true })
}
...
export const toFixed = (
  ...
  const numericValue = Number(value)
  return numericValue.toLocaleString("en-US", { maximumFractionDigits : decimalPlaces, useGrouping: true })
}
