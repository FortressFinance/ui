...
export function middleware(req: NextRequest) {
  ...
  const shouldRedirectToApp = process.env.NODE_ENV === "production" && process.env.VERCEL === "1" && hostname === "fortress.finance";
  const shouldRedirectToLandingPage = process.env.NODE_ENV === "production" && process.env.VERCEL === "1" && hostname === "app.fortress.finance";
