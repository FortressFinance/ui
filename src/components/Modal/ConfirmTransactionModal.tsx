      ...
      <PurpleModalContent className="grid grid-cols-1 space-y-4 divide-pink-800">
        {outputAmountMin ? (
          ...
          <>
            <div>
              <p className="mb-2">
                We're unable to preview your {type} transaction right now.
                Please try again later.
              </p>
              <p className="text-sm">
                Without a successful {type} preview, we're unable to honor your
                slippage preferences through the UI. To protect you from losses,
                we will not allow you to {type} without a minimum amount.
              </p>
            </div>
