...
export const Consent: FC = () => {
  ...
  const understandDisclaimer = useConsentStorage(state => state.understandDisclaimer)
  ...
  return (
    <>
      <PurpleModal className="w-auto p-6" isOpen={isOpen} onClose={() => null}> 
        <Dialog.Title
          as="h3"
          className="text-xl font-base leading-6 text-pink-100"
        >
          DISCLAIMER
        </Dialog.Title>
        <div className="mt-6 w-full max-w-prose text-sm leading-6 text-pink-100">
          <p className="mb-3">
            ...
            interact (in both cases, “interacting”) with Finance Fortress, you
