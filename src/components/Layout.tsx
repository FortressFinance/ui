...
const Layout: FC<PropsWithChildren> = ({ children }) => {
  ...
  let concentratorsItem = (
    <Menu.Item as={DropdownMenuItemLink} href={appLink("/yield/concentrators")}>
      Concentrators
    </Menu.Item>
  )

  if (DISABLE_CONCENTRATORS) {
    concentratorsItem = (
      <Menu.Item as={DropdownMenuItemLink} href={appLink("#")} disabled>
